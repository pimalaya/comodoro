...
RELEASES_URL="https://github.com/pimalaya/comodoro/releases"
...
curl -sLo "$tmpdir/comodoro.tgz" \
     "$RELEASES_URL/latest/download/comodoro.$target.tgz"

echo "Installing binary…"
tar -xzf "$tmpdir/comodoro.tgz" -C "$tmpdir"
